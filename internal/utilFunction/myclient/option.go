...
func WithAppCredential(cred *client.AppCredentialConfig) ClientOption {
	return func(c *StreamClient) {
...
func WithUserAgent(ua *client.UserAgentConfig) ClientOption {
	return func(c *StreamClient) {
		if ua.Valid() != nil {
			ua = client.NewDingtalkGoSDKUserAgent()
		}
